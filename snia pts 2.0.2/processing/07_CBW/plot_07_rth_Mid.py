...
TCSet = [1, 2, 32]
QDSet = [1, 16, 32]
CSVFileList = ['results/test07_Mid_RTH_clat.1.log',
               'results/test07_Mid_RTH_clat.2.log']
...
print('Mid-IOPS read latency stats:')
...
fig.savefig(str(args.device_name) + '_rth_Mid.png', format='png', bbox_inches='tight')
fig.savefig(str(args.device_name) + '_rth_Mid.pdf', format='pdf', bbox_inches='tight')
