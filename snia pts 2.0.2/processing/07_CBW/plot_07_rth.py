...
rth_data0 = pd.read_csv('results/test07_Min_RTH_clat.1.log', sep = ',',
                      usecols=[1], names=['Lat'])
...
print('Min-IOPS read latency stats:')
...
fig.savefig(str(args.device_name) + '_rth_Min.png', format='png', bbox_inches='tight')
fig.savefig(str(args.device_name) + '_rth_Min.pdf', format='pdf', bbox_inches='tight')
